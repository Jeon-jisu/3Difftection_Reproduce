...
model.load_state_dict(load_state_dict('./lightning_logs/version_1/checkpoints/epoch=2-step=37500.pth', location='cuda'))
# .lightning_logs/version_1/checkpoints/epoch=2-step=37500.pth
model = model.cuda()

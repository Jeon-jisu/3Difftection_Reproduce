...
# JSON 파일 읽기
with open('/node_data/urp24s_jsjeon/3Difftection_Reproduce/ControlNet2/raw/Training/annotations_new.json', 'r') as file:
    data = json.load(file)
...
# 그래프 저장
plt.savefig('rotation_angles_histogram2.png')
plt.close()

print("Histogram has been saved as 'rotation_angles_histogram2.png'")

...
controlnet_weights = torch.load('./checkpoints/train_66_only_2_warp_2_5_v2/model-epoch=159-train_loss=0.00.ckpt')
if 'state_dict' in controlnet_weights:
    controlnet_weights = controlnet_weights['state_dict']

# 원본 Stable Diffusion 가중치 로드
sd_weights = torch.load('/node_data/urp24s_jsjeon/3Difftection_Reproduce/omni3d/controlnet/models/v1-5-pruned.ckpt')
